    ...
    <>
      <SafeAreaView className=" flex-1 my-7 flex items-center justify-around">
        <View className="space-y-2">
          ...
          <Text style={{ fontSize: hp(2) }}  className=" text-center text-gray-600 tracking-wider font-semibold">I am here to help you with your queries.</Text>
        </View>
        <Image
        style={{ height: hp(50),width: wp(75) }}
          source={require("../assets/images/bots.png")}
          className="w-72 h-72"
        />
        <TouchableOpacity 
